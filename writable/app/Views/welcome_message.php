...
<head>
	<meta charset="UTF-8">
	<title>Welcome to possss 4!</title>
...
<header>
	...
	<div class="heroe">
		...
		<h1>Natalia Ayelen Gauna <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

		<h2>it seems like this is an intelligent platform codeigniter</h2>
